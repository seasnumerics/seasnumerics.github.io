...
#case (1)
  ...
  #declare Camera_Position = < 100,200,100.00> ;  // diagonal view
  #declare Camera_Look_At  = < 50, 100, 50.00> ;
  #declare Camera_Angle    =  65;
  #declare Camera_Rotate = <0,0,0>;  
#break
#case (2)
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<1200,2500,-2000> color White*0.9}           // sun light
...
#include "Xmemb.inc"
object {m_Xmemb
   texture{ pigment{ color rgbt<0.0, 0.9, 0.9, 0.4>}}
   //rotate<0,0,30>
}
